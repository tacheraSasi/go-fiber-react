    ...
    <AuthLayout>
      <Card className="mx-auto w-full max-w-md relative z-10 bg-neutral-900 border-neutral-800 shadow-2xl rounded-lg p-6">
        <CardHeader className="space-y-2 pb-6">
          <CardTitle className="text-3xl font-bold text-neutral-100">Welcome to ShowBase!</CardTitle>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-4 text-center">
            ...
            <Link to="/dashboard">
              <Button className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-2 rounded-md transition-colors duration-300 ease-in-out">
                Enter the Realm of Wonders
              </Button>
            </Link>
            
            <p className="text-neutral-500 mt-4 text-xs">
              If you have any questions, feel free to <Link to="/help" className="text-red-500 hover:text-red-600 underline">visit our help center</Link>.
            </p>
          </div>
        </CardContent>
      </Card>
